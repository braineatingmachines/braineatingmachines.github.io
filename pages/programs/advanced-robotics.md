    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div class="text-center">
          <div class="feature-icon bg-lego-green mx-auto">
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600">Arduino, Raspberry Pi, CAD</p>
        </div>
      </div>
      ...
      <div class="bg-green-50 border-l-4 border-lego-green p-6 rounded-r-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-gray-700">
          ...
          <div class="flex items-start space-x-2">
            ...
            <span>Microcontroller programming (Arduino, Pi Pico)</span>
          </div>
          <div class="flex items-start space-x-2">
            <svg class="w-5 h-5 text-lego-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            </svg>
            <span>Electronic circuit design and debugging</span>
          </div>
          <div class="flex items-start space-x-2">
            <svg class="w-5 h-5 text-lego-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            </svg>
            <span>CAD design and 3D printing</span>
          </div>
          <div class="flex items-start space-x-2">
            <svg class="w-5 h-5 text-lego-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
  ...
  <div class="container-custom">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div class="order-2 lg:order-1">
        <div class="card">
          <div class="overflow-hidden rounded-t-lg">
            <img src="{{ '/assets/img/electronics.jpeg' | relative_url }}" alt="Week 1: Electronics & Microcontrollers" class="w-full h-80 object-cover">
          </div>
          <div class="p-6">
      ...
      <div class="order-1 lg:order-2">
        <div class="inline-flex items-center bg-purple-600 text-white px-4 py-2 rounded-full text-sm font-semibold mb-4">
...
<section class="section bg-white">
  <div class="container-custom">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div>
        <div class="inline-flex items-center bg-lego-green text-white px-4 py-2 rounded-full text-sm font-semibold mb-4">
...
<section class="section bg-gray-50">
  <div class="container-custom">
    <div class="max-w-3xl mx-auto">
      <h2 class="text-center text-gray-900 mb-8">Prerequisites</h2>
      <div class="bg-white rounded-xl shadow-md p-8">
        ...
        <ul class="space-y-3 text-gray-700">
          <li class="flex items-start space-x-3">
            <svg class="w-6 h-6 text-lego-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            </svg>
            <div>
              <strong>Completed block-based robotics programs</strong> - LEGO SPIKE Prime, EV3, or similar experience required
            </div>
          </li>
          <li class="flex items-start space-x-3">
            <svg class="w-6 h-6 text-lego-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div>
              <strong>Strong programming fundamentals</strong> - Understanding of loops, conditionals, variables, and functions
            </div>
          </li>
          <li class="flex items-start space-x-3">
            <svg class="w-6 h-6 text-lego-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div>
              <strong>Interest in advanced robotics</strong> - Desire to join high school robotics teams or pursue competitive STEM programs
            </div>
          </li>
          <li class="flex items-start space-x-3">
            <svg class="w-6 h-6 text-lego-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div>
              <strong>8th-9th grade students</strong> - Program designed for students transitioning to high school
            </div>
          </li>
        </ul>
      </div>
        ...
        <div class="card p-6">
          ...
          <ul class="space-y-3 text-gray-700">
            ...
            <li class="flex items-start space-x-2">
              ...
              <div>
                <strong>Age Range:</strong> 8th-9th grade
              </div>
            </li>
            <li class="flex items-start space-x-2">
              <svg class="w-5 h-5 text-lego-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div>
                <strong>Class Size:</strong> Small groups for hands-on instruction
              </div>
            </li>
          </ul>
        </div>
        ...
        <div class="card p-6">
          ...
          <ul class="space-y-3 text-gray-700">
            <li class="flex items-start space-x-2">
              ...
              <span>All electronics components and materials</span>
            </li>
            <li class="flex items-start space-x-2">
              <svg class="w-5 h-5 text-lego-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
              </svg>
              <span>Arduino and Raspberry Pi Pico boards</span>
            </li>
            <li class="flex items-start space-x-2">
              <svg class="w-5 h-5 text-lego-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
              </svg>
              <span>Access to 3D printers and CAD software</span>
            </li>
            <li class="flex items-start space-x-2">
              <svg class="w-5 h-5 text-lego-green flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
  ...
  <div class="container-custom">
    <div class="max-w-3xl mx-auto text-center">
      ...
      <p class="text-xl text-blue-100 mb-8">
        We're developing the curriculum and schedule for this advanced program. Check back soon for complete details on dates, registration, and full course outline, or join our mailing list to be notified.
      </p>
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
