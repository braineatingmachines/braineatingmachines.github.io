---
layout: page
title: Robot Game - BIOGLOW™ Missions & Guidebooks
description: BIOGLOW™ Robot Game missions video and official FIRST guidebooks.
permalink: /fll-2026-27/robot-game/
custom_css: fll-2026-27
custom_js: fll-calendar
---

**Table of Contents:**
- [Robot Game Missions Video](#robot-game-missions-video)
...
Robot Game is one of the three judged components of every FLL season, alongside the Innovation Project and Core Values. Teams build and program a robot to autonomously complete missions on a themed table within a two-and-a-half-minute match.
