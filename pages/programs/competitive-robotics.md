  ...
  <div class="container-custom py-16 md:py-20">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <p class="text-xl text-gray-600 mb-8">
        Students who've completed our <a href="/foundations-of-robotics"
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <a href="/fll-2026-27" class="btn btn-primary px-10">
    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div class="text-center">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-2">Full Season</h3>
          <p class="text-gray-600">September - December</p>
        </div>
        ...
        <div class="text-center">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-2">Team-Based</h3>
          <p class="text-gray-600">Collaborative learning</p>
        </div>
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600">Regional & state competitions</p>
        </div>
      </div>
      ...
      <div class="bg-red-50 border-l-4 border-lego-red p-6 rounded-r-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-gray-700">
          <div class="flex items-start space-x-2">
            <svg class="w-5 h-5 text-lego-red flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            </svg>
            <span>Robot design and building through Foundations of Robotics (LEGO® SPIKE Prime)</span>
          </div>
          <div class="flex items-start space-x-2">
            <svg class="w-5 h-5 text-lego-red flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            </svg>
            <span>Block/Python programming for bot</span>
          </div>
          <div class="flex items-start space-x-2">
            <svg class="w-5 h-5 text-lego-red flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            </svg>
            <span>Innovation project research and presentation</span>
          </div>
          <div class="flex items-start space-x-2">
            <svg class="w-5 h-5 text-lego-red flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            </svg>
            <span>Competition strategy and teamwork</span>
          </div>
          <div class="flex items-start space-x-2">
            <svg class="w-5 h-5 text-lego-red flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            </svg>
            <span>Core values and gracious professionalism</span>
          </div>
          <div class="flex items-start space-x-2">
            <svg class="w-5 h-5 text-lego-red flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
        ...
        <div class="card p-6">
          ...
          <ul class="space-y-3 text-gray-700">
            <li class="flex items-start space-x-2">
              ...
              <div>
                <strong>Duration:</strong> September - December (full season)
              </div>
            </li>
            <li class="flex items-start space-x-2">
              <svg class="w-5 h-5 text-lego-red flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div>
                <strong>Schedule:</strong> Twice weekly, 90 minutes per session
              </div>
            </li>
            <li class="flex items-start space-x-2">
              <svg class="w-5 h-5 text-lego-red flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div>
                <strong>Age Range:</strong> 4th-8th grade (ages 9-16)
              </div>
            </li>
            <li class="flex items-start space-x-2">
              <svg class="w-5 h-5 text-lego-red flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div>
                <strong>Team Size:</strong> 4-10 students per team
              </div>
            </li>
          </ul>
        </div>
        ...
        <div class="card p-6">
          ...
          <ul class="space-y-3 text-gray-700">
            <li class="flex items-start space-x-2">
              ...
              <span>Complete LEGO® Spike Prime robotics kit</span>
            </li>
            <li class="flex items-start space-x-2">
              <svg class="w-5 h-5 text-lego-blue flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
              </svg>
              <span>All competition entry fees</span>
            </li>
            <li class="flex items-start space-x-2">
              <svg class="w-5 h-5 text-lego-blue flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
              </svg>
              <span>Expert coaching and mentorship</span>
            </li>
            <li class="flex items-start space-x-2">
              <svg class="w-5 h-5 text-lego-blue flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
              </svg>
              <span>Team t-shirt and materials</span>
            </li>
            <li class="flex items-start space-x-2">
              <svg class="w-5 h-5 text-lego-blue flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
