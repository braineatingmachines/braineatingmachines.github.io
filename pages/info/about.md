  ...
  <section class="mb-16 fade-in-section">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div class="text-center fade-in-section">
        ...
        <h3 class="text-xl font-bold text-gray-900 mb-2">Hands-On Learning</h3>
        <p class="text-gray-600">Real-world STEM experiences through building and programming robots</p>
      </div>

      <div class="text-center fade-in-section animation-delay-200">
        <div class="w-16 h-16 bg-lego-red rounded-full flex items-center justify-center mx-auto mb-4">
          <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
            <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path>
          </svg>
        </div>
        <h3 class="text-xl font-bold text-gray-900 mb-2">Team Collaboration</h3>
        <p class="text-gray-600">Developing communication and teamwork skills through group challenges</p>
      </div>

      <div class="text-center fade-in-section animation-delay-400">
        <div class="w-16 h-16 bg-lego-yellow rounded-full flex items-center justify-center mx-auto mb-4">
          <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
